...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/project/project.ipynb.

# %% auto 0
__all__ = ['Project', 'get_dataset']

# %% ../nbs/project/project.ipynb 3
import typing as t
...
def get_dataset(self, name: str, model: t.Type[NotionModel]) -> Dataset:
    """Get an existing dataset by name."""
    if self.datasets_page_id == "":
        raise ValueError("Datasets page ID is not set")

    # Search for database with given name
    database_id = self._notion_repo.get_database_id(
